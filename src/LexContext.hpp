...
namespace lex {
  ...
  class LexContext {
    ...
    public:
      ...
      // captures the specified character under the cursor. If false is returned, there was no more room
      virtual bool capture(char ch)=0;
  ...
  template<const size_t TCapacity> class StaticLexContext : virtual public LexContext {
    ...
    public:
      ...
      bool capture(char ch) override {
        m_capture[m_captureCount++] = (uint8_t)ch;
        m_capture[m_captureCount] = 0;
        return true;
